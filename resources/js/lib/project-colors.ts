...
export const PROJECT_COLORS: Record<ProjectColorKey, ProjectColorStyles> = {
    ...
    emerald: {
        ...
        itemChecked:
            'data-[state=checked]:bg-emerald-50 dark:data-[state=checked]:bg-emerald-950/40',
    ...
    amber: {
        ...
        itemChecked:
            'data-[state=checked]:bg-amber-50 dark:data-[state=checked]:bg-amber-950/40',
    ...
    orange: {
        ...
        itemChecked:
            'data-[state=checked]:bg-orange-50 dark:data-[state=checked]:bg-orange-950/40',
    ...
    red: {
        ...
        itemChecked:
            'data-[state=checked]:bg-red-50 dark:data-[state=checked]:bg-red-950/40',
    ...
    violet: {
        ...
        itemChecked:
            'data-[state=checked]:bg-violet-50 dark:data-[state=checked]:bg-violet-950/40',
    ...
    sky: {
        ...
        itemChecked:
            'data-[state=checked]:bg-sky-50 dark:data-[state=checked]:bg-sky-950/40',
    ...
    pink: {
        ...
        itemChecked:
            'data-[state=checked]:bg-pink-50 dark:data-[state=checked]:bg-pink-950/40',
